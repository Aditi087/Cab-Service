    ...
    <div className="ride_body">
      <div className="ride_logo">
        <form className="ride_form">
          ...
          />
          <label for="vehicle1" className="ride_label">Taxi</label>
          <br />
          <input
            className="ride_input"
            type="checkbox"
          ...
          />
          <label for="vehicle2" className="ride_label">Ola/Uber</label>
          <br />
          <input
            className="ride_input"
            type="checkbox"
          ...
          />
          <label for="vehicle3" className="ride_label"> Car Pooling</label>
          <br />
          <input
            className="ride_input"
            type="checkbox"
            ...
            value="Auto"
            onChange={() => {
              setischecked3(!ischecked4);
            }}
          />
          <label for="vehicle4" className="ride_label"> Auto</label>
          <br />
          <input
            className="ride_input"
            type="checkbox"
            ...
            value="Toto"
            onChange={() => {
              setischecked3(!ischecked5);
            }}
          />
          <label for="vehicle5" className="ride_label"> Toto</label>
          <br />
          <input
            className="ride_input"
            type="checkbox"
          ...
          />
          <label for="vehicle3" className="ride_label"> Bike</label>
          <br />
          <input
            className="ride_input"
            type="checkbox"
          ...
          />
          <label for="vehicle7" className="ride_label">Ride Sharing</label>
          <br />
          <Button href="/location" className="ride_btn" type="submit" value="Submit">
            Next
          </Button>
        </form>
      </div>
